Curated resources for mathematics, physics, computer science. See [tree](tree), [misc](misc.md), [suggested/math](suggested/math.md), [suggested/cs](suggested/cs.md), [ramanujan](ramanujan.md).
...
- **Crafting Interpreters** — Robert Nystrom — [book](https://craftinginterpreters.com)
